...
<body>
<div class="logo">
    <img src="../img/logo.png" class="logo-img img"></img>
</div>
<div class="login">
    <span class="title"><?php echo $type ?></span>

    <form action="" method="post">
        <input type="text" name="username" placeholder="Логин" class="field text">
    ...
    <div class="bottom-title text">
        <a href="login.php?type=<?php echo 'Войти' == $type ? 'Зарегистрируйтесь' : 'Войти' ?>"
           class="link"> <?php echo 'Войти' == $type ? 'Зарегистрируйтесь' : 'Войти' ?></a>
    </div>
</div>
</body>
<?php

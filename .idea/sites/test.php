...
?>
    ...
    <body onload="moreActions('<?php echo implode(' ', $arrayOfQuestions) ?>')">
    <?php include 'header.html' ?>
    <form method="get">
        <div class="outputTest text">
            <div class="outputSubject">
                <span class="subjectText">Предмет</span>
            </div>
            <div class="outputTheme">
                <span class="themeText">SDSDSDSD</span>
            </div>
            <div class="outputQuestion">
                <div class="question">
                    <span class="questionText"></span>
                    <input type="hidden" name="checkbox[question]" class="hidden">
                </div>
                <div class="questionAnswers">
                    <div class="answer">
                        <input type="checkbox" name="checkbox[answer]" class="checkedOrNot">
                        <label class="answerText"></label>
                    </div>
                </div>
            </div>
        </div>
        <div class="actions text">
            <input class="save text" onclick="check()" type="submit" value="Сохранить">
        </div>
...
if (isset($_GET['checkbox'])) {
    ...
    echo
        "<script>
alert('Вы ответили правильно на ' + $thisRights + 'вопросов из' + $allRights )
        </script>";

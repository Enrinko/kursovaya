function add(typeOfDiv, typeOfParent, thisValue) {
    ...
    let parent = thisValue.value == 0 ? thisValue.closest('.question-with-answer') : document.querySelector('.' + typeOfParent)
    if ('question-with-answer'.localeCompare(typeOfDiv) == 0) {
        ...
        for (let i = 0; i < allAnswers.length; i++) {
            allAnswers.item(i).innerHTML = i == 0 ? onlyOneAnswer.innerHTML : ""
        }
    } else {
